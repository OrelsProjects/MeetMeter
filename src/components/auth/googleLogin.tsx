...
export default function GoogleLogin({
  ...
  return (
    <div
      className={`w-full h-12 flex flex-row gap-2 bg-background dark:bg-card-foreground dark:text-card justify-center items-center rounded-lg md:hover:cursor-pointer ${className}`}
